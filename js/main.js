...
//     ]
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        //console.log(Object.keys(wines));
        for (let i = 0; i < Object.keys(wines).length; i++) {
          wineStructure += "<div class = \"col-3 wine-block m-2\">"+"<div class=\"p-2\">" +
          "<a href=\"wine.html\">" + "<img src = \"./images/" + winesArr[i].picture + "\">"
           + "</a>" + "</div>"+"<div>"+"<p>" + winesArr[i].country + "," + winesArr[i].region 
           + "</p>" + "<h6>" + "<a href=\"wine.html\">" + winesArr[i].name + "</a>" + "</h6>"
            + "<p>" + winesArr[i].grapes + "," + winesArr[i].year + "</p>" + "</div>" + "</div>";
        }
...
// récupérer la valeur du input quand on appuye sur le button
  //fonction search
  ...
  //  list.innerHTML = "";
    ...
    $.get(urlSearch, function(data){
      ...
      for(let i=0; i<Object.keys(data).length; i++){
        // list.innerHTML += "<li>"+Object.values(data)[i].name+"</li>";
